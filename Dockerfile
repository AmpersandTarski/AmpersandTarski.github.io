...
ADD https://github.com/AmpersandTarski/prototype-frontend/archive/refs/heads/documentation.zip /tmp/prototypeFrontend.zip
...
RUN unzip /tmp/prototypeFrontend.zip 'prototypeFrontend-documentation/docs/*' -d /tmp/prototypeFrontend/ \
    && cp -R /tmp/prototypeFrontend/prototypeFrontend-documentation/docs/ /app/docs/prototypeFrontend
